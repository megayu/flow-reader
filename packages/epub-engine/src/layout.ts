...
type LayoutEvents = { updated: [LayoutProperties, Partial<LayoutProperties>] }
 ...
 */
class Layout extends EventEmitter<LayoutEvents> {
  declare settings: LayoutSettings
  declare name: string
  declare _spread: boolean
  declare _minSpreadWidth: number
  declare _evenSpreads: boolean
  declare _flow: 'scrolled' | 'paginated'
  declare width: number
  declare height: number
  declare spreadWidth: number
  declare pageWidth: number
  declare delta: number
  declare columnWidth: number
  declare gap: number
  declare divisor: number
  declare props: LayoutProperties
   ...
   * @param  {object} props
   */
  update(props: Partial<LayoutProperties>) {
    // Remove props that haven't changed
    ;(Object.keys(props) as (keyof LayoutProperties)[]).forEach((propName) => {
